...
vector<bool> ApplikationsLayer::dataToBoolean(string aString) // konverterer indkommen data til bool
{
	vector<bool> data;
...
string ApplikationsLayer::BooleanTodata(vector<bool>& bVector)
{
...
void ApplikationsLayer::print(vector<bool>& aVector, string aName)
{
